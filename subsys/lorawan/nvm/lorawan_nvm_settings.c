			   ...
			   void *cb_arg, void *param)
{
	...
	LOAD_SETTINGS(nvm, Crypto)
	LOAD_SETTINGS(nvm, MacGroup1)
	LOAD_SETTINGS(nvm, MacGroup2)
#if !defined(CONFIG_LORAWAN_SE_HAS_OWN_NVM)
	LOAD_SETTINGS(nvm, SecureElement)
#endif
	LOAD_SETTINGS(nvm, RegionGroup1)
	LOAD_SETTINGS(nvm, RegionGroup2)
	LOAD_SETTINGS(nvm, ClassB)
